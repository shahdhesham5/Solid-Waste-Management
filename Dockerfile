...
COPY . /usr/src/my_upgeo/
WORKDIR /usr/src/my_upgeo
...
RUN chmod +x /usr/src/my_upgeo/tasks.py \
    && chmod +x /usr/src/my_upgeo/entrypoint.sh
...
ENTRYPOINT service cron restart && service memcached restart && /usr/src/my_upgeo/entrypoint.sh
