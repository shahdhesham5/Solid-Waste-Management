...
echo "-----------------------------------------------------"
echo "STARTING my_upgeo RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./my_upgeo/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED my_upgeo RESTORE $(date)"
echo "-----------------------------------------------------"
